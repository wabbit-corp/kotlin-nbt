...
// managed-integrity-v1: Rut3JAwuzQQ
//
...
mavenPublishing {
    coordinates("one.wabbit", "kotlin-nbt", project.version.toString())
    publishToMavenCentral()
    signAllPublications()
    pom {
        name.set("kotlin-nbt")
        description.set("kotlin-nbt")
        url.set("https://github.com/wabbit-corp/kotlin-nbt")
        licenses {
            license {
        ...
        scm {
            url.set("https://github.com/wabbit-corp/kotlin-nbt")
            connection.set("scm:git:git://github.com/wabbit-corp/kotlin-nbt.git")
            developerConnection.set("scm:git:ssh://git@github.com/wabbit-corp/kotlin-nbt.git")
        }
    }
}
...
publishing {
    publications.withType<org.gradle.api.publish.maven.MavenPublication>().configureEach {
        val configuredArtifactId = "kotlin-nbt"
    ...
    sourceSets {
        val commonMain by getting {
            dependencies {
                ...
                implementation("one.wabbit:kotlin-compression:0.1.0")
        ...
        extensions.findByType(DokkaExtension::class)?.apply {
            ...
            dokkaSourceSets.configureEach {
                ...
                sourceLink {
                    ...
                    remoteUrl("https://github.com/wabbit-corp/kotlin-nbt/tree/master/src")
