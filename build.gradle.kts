...
kover {
    ...
    //             // title.set("kotlin-nbt Code Coverage") // Uncomment to customize title
    //         }
    //         xml {
...
dokka {
    ...
    dokkaSourceSets.main {
        ...
        sourceLink {
            ...
            remoteUrl("https://github.com/wabbit-corp/kotlin-nbt/tree/master/src/main/kotlin")
