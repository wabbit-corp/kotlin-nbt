...
- Canonical repo target: `kotlin-nbt`. Useful entrypoints: `dev project show kotlin-nbt`, `dev build kotlin-nbt`, `dev check kotlin-nbt`.
- Setup-managed files are regenerated with `dev setup kotlin-nbt`; avoid hand-editing stamped generated files.
